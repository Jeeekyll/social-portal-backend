...
export class AddForceMigration1637159113805 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "comments" ("id" SERIAL NOT NULL, "text" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "authorId" integer, "articleId" integer, CONSTRAINT "PK_8bf68bc960f2b69e818bdb90dcb" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "messages" ("id" SERIAL NOT NULL, "text" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, "roomId" integer, CONSTRAINT "PK_18325f38ae6de43878487eff986" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "joined-rooms" ("id" SERIAL NOT NULL, "socketId" character varying NOT NULL, "userId" integer, "roomId" integer, CONSTRAINT "PK_ea0d6e4aa682c07a50261322531" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "rooms" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_0368a2d7c215f2d0458a54933f2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "connected-users" ("id" SERIAL NOT NULL, "socketId" character varying NOT NULL, "userId" integer, CONSTRAINT "PK_a0def386015108d850c36be4849" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "rooms_users_users" ("roomsId" integer NOT NULL, "usersId" integer NOT NULL, CONSTRAINT "PK_ec0e74b500eaad3d92f5179fb01" PRIMARY KEY ("roomsId", "usersId"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "joined-rooms" ADD CONSTRAINT "FK_b0d05f3b9cc9d89dbfe96620ca5" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "joined-rooms" ADD CONSTRAINT "FK_1c02a7506b265f1e8c61c8c30f4" FOREIGN KEY ("roomId") REFERENCES "rooms"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "connected-users" ADD CONSTRAINT "FK_3f0609d57efc68ecec5019fbd2b" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "articles" ADD CONSTRAINT "FK_9cf383b5c60045a773ddced7f23" FOREIGN KEY ("categoryId") REFERENCES "categories"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "rooms_users_users" ADD CONSTRAINT "FK_6b3c5f4bbfb29a84a57e442af54" FOREIGN KEY ("usersId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "connected-users" DROP CONSTRAINT "FK_3f0609d57efc68ecec5019fbd2b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "joined-rooms" DROP CONSTRAINT "FK_1c02a7506b265f1e8c61c8c30f4"`,
    );
    await queryRunner.query(
      `ALTER TABLE "joined-rooms" DROP CONSTRAINT "FK_b0d05f3b9cc9d89dbfe96620ca5"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_6b3c5f4bbfb29a84a57e442af5"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_cbe951142bc45a33a744256516"`,
    );
